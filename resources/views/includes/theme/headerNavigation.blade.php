            ...
            <ul class="dropdown-menu multi">
              <div class="row">
                ...
                <div class="col-sm-3 w3l">
                  <a href="{{url('/kitchen')}}"><img src="{{asset('images/me.png')}}" class="img-responsive" alt=""></a>
                </div>
          ...
          <li class="dropdown">
            ...
            <ul class="dropdown-menu multi multi1">
              <div class="row">
                ...
                <div class="col-sm-3 w3l">
                  <a href="{{url('/care')}}"><img src="{{asset('images/me1.png')}}" class="img-responsive" alt=""></a>
                </div>
                <div class="clearfix"></div>
              </div>
            </ul>
          ...
          <li class="dropdown">
            ...
            <ul class="dropdown-menu multi multi2">
              <div class="row">
                <div class="col-sm-3">
                  <ul class="multi-column-dropdown">
                    <li><a href="{{url('/hole')}}"><i class="fa fa-angle-right" aria-hidden="true"></i>Cleaning Accessories</a></li>
                    <li><a href="{{url('/hole')}}"><i class="fa fa-angle-right" aria-hidden="true"></i>CookWear</a></li>
                    <li><a href="{{url('/hole')}}"><i class="fa fa-angle-right" aria-hidden="true"></i>Detergents</a></li>
                    <li><a href="{{url('/hole')}}"><i class="fa fa-angle-right" aria-hidden="true"></i>Gardening Needs</a></li>
                ...
                <div class="col-sm-3">
                  ...
                  <ul class="multi-column-dropdown">
                    <li><a href="{{url('/hole')}}"><i class="fa fa-angle-right" aria-hidden="true"></i>Kitchen & Dining</a></li>
                    <li><a href="{{url('/hole')}}"><i class="fa fa-angle-right" aria-hidden="true"></i>KitchenWear</a></li>
                    <li><a href="{{url('/hole')}}"><i class="fa fa-angle-right" aria-hidden="true"></i>Pet Care</a></li>
                    <li><a href="{{url('/hole')}}"><i class="fa fa-angle-right" aria-hidden="true"></i>Plastic Wear</a></li>
                ...
                <div class="col-sm-3">
                  ...
                  <ul class="multi-column-dropdown">
                    <li><a href="{{url('/hole')}}"><i class="fa fa-angle-right" aria-hidden="true"></i>Pooja Needs</a></li>
                    <li><a href="{{url('/hole')}}"><i class="fa fa-angle-right" aria-hidden="true"></i>Serveware</a></li>
                    <li><a href="{{url('/hole')}}"><i class="fa fa-angle-right" aria-hidden="true"></i>Safety Accessories</a></li>
                    <li><a href="{{url('/hole')}}"><i class="fa fa-angle-right" aria-hidden="true"></i>Festive Decoratives </a></li>

                  </ul>
                </div>
                <div class="col-sm-3 w3l">
                  <a href="{{url('/hole')}}"><img src="{{asset('images/me2.png')}}" class="img-responsive" alt=""></a>
                </div>
                <div class="clearfix"></div>
              </div>
            </ul>
