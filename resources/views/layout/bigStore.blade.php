				...
				<div class=" con-w3l">
							<div class="col-md-3 pro-1">
								...
								<a href="#" data-toggle="modal" data-target="#myModal17" class="offer-img">
										<img src="{{asset('images/of16.png')}}" class="img-responsive" alt="">
									</a>
									<div class="mid-1">
										<div class="women">
							...
							<div class="col-md-3 pro-1">
								<div class="col-m">
									<a href="#" data-toggle="modal" data-target="#myModal18" class="offer-img">
										<img src="{{asset('images/of17.png')}}" class="img-responsive" alt="">
									</a>
									<div class="mid-1">
										<div class="women">
							...
							<div class="col-md-3 pro-1">
								<div class="col-m">
									<a href="#" data-toggle="modal" data-target="#myModal19" class="offer-img">
										<img src="{{asset('images/of18.png')}}" class="img-responsive" alt="">
									</a>
									<div class="mid-1">
										<div class="women">
							...
							<div class="col-md-3 pro-1">
								<div class="col-m">
									<a href="#" data-toggle="modal" data-target="#myModal20" class="offer-img">
										<img src="{{asset('images/of19.png')}}" class="img-responsive" alt="">
									</a>
									<div class="mid-1">
										<div class="women">
							...
							<div class="col-md-3 pro-1">
								...
								<a href="#" data-toggle="modal" data-target="#myModal21" class="offer-img">
										<img src="{{asset('images/of20.png')}}" class="img-responsive" alt="">
									</a>
									<div class="mid-1">
										<div class="women">
							...
							<div class="col-md-3 pro-1">
								<div class="col-m">
									<a href="#" data-toggle="modal" data-target="#myModal22" class="offer-img">
										<img src="{{asset('images/of21.png')}}" class="img-responsive" alt="">
									</a>
									<div class="mid-1">
										<div class="women">
							...
							<div class="col-md-3 pro-1">
								<div class="col-m">
									<a href="#" data-toggle="modal" data-target="#myModal23" class="offer-img">
										<img src="{{asset('images/of22.png')}}" class="img-responsive" alt="">
									</a>
									<div class="mid-1">
										<div class="women">
							...
							<div class="col-md-3 pro-1">
								<div class="col-m">
									<a href="#" data-toggle="modal" data-target="#myModal24" class="offer-img">
										<img src="{{asset('images/of23.png')}}" class="img-responsive" alt="">
									</a>
									<div class="mid-1">
										<div class="women">
...
<div class="footer">
	<div class="container">
		...
		<div class="copy-right">
			<p> &copy; 2016 Big store. All Rights Reserved | Design by  <a href=""> W3layouts</a></p>
		</div>
	</div>
</div>
<!-- //footer-->
