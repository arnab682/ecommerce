...
@section('content')
    ...
    <div class="row">
        <div class="col-md-12">
          <div><a href="{{url('/label/create')}}" class="btn btn-success">Add New</a>
               ...
               <tbody>
                 <tr>
                   ...
                   <td></a>
                       ...
                       {!! Form::open(array('url' => ['label',$label->id],'onclick'=>"return confirm('Are you sure you want to delete this item?');",'method' => 'DELETE')) !!}
